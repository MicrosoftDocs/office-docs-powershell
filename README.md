...
5. You can click the Preview changes link to see what the changes will look like. IMPORTANT: The layout of headings and subheadings must follow a very specific schema. Any deviation will throw errors in the Pull Request. The schema can be found here: https://github.com/PowerShell/platyPS/blob/master/platyPS.schema.md 
