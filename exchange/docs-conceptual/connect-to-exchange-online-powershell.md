...
> [!TIP]
> The connection instructions in this article also apply to Exchange Online Protection PowerShell (PowerShell in [the Built-in security add-on for on-premises mailboxes](/exchange/standalone-eop/standalone-eop)).
