...
description: "Learn about the structure and syntax of cmdlets in Exchange PowerShell, Exchange Online PowerShell, Security & Compliance PowerShell, and Exchange Online Protection PowerShell (PowerShell in the Built-in security add-on for on-premises mailboxes)."
---
