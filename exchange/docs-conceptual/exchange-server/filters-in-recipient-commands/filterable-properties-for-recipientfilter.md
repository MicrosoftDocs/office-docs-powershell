...
| _MailboxMoveFlags_ <br/> | _msExchMailboxMoveFlags_ <br/> |For valid values, see the description of the _Flags_ parameter in[Get-MoveRequest](../../exchange-ps/move-and-migration-cmdlets/get-moverequest.md).  <br/> ||
...
| _MailboxMoveStatus_ <br/> | _msExchMailboxMoveStatus_ <br/> |For valid values, see the description of the _MoveStatus_ parameter in[Get-MoveRequest](../../exchange-ps/move-and-migration-cmdlets/get-moverequest.md).  <br/> ||
...
| _PreviousRecipientTypeDetails_ <br/> | _msExchPreviousRecipientTypeDetails_ <br/> |For valid values, see the description of the _RecipientTypeDetails_ parameter in[Get-Recipient](../../exchange-ps/users-and-groups-cmdlets/get-recipient.md).  <br/> ||
...
| _RecipientType_ <br/> |n/a  <br/> |For valid values, see the description of the _RecipientType_ parameter in[Get-Recipient](../../exchange-ps/users-and-groups-cmdlets/get-recipient.md).  <br/> ||
| _RecipientTypeDetails_ <br/> |n/a  <br/> |For valid values, see the description of the _RecipientTypeDetails_ parameter in[Get-Recipient](../../exchange-ps/users-and-groups-cmdlets/get-recipient.md).  <br/> ||
