...
```
Enable-UMAutoAttendant [-Identity] <UMAutoAttendantIdParameter> [-Confirm] [-DomainController <Fqdn>] [-WhatIf]
 [<CommonParameters>]
```
...
[Online Version](https://docs.microsoft.com/powershell/module/exchange/unified-messaging/enable-umautoattendant)
