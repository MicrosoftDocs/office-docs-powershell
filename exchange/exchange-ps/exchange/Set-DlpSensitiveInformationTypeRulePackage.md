...
Use the Set-DlpSensitiveInformationTypeConfig cmdlet to update existing data loss prevention (DLP) sensitive information type rule packages in the Security & Compliance Center.
...
```
Set-DlpSensitiveInformationTypeRulePackage [-FileData] <Byte[]> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
[Online Version](https://technet.microsoft.com/library/0a3f71cf-7799-4e39-9209-6a38aefd6d06.aspx)
