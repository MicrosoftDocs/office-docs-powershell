...
- The value set on `-SharedCalendarSyncStartDate` is used when initializing the calendar folder sync. After that, every newly added, updated, and deleted item is processed and synced, regardless of that date setting.
