...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-partnerapplication
...
```
Remove-PartnerApplication [-Identity] <PartnerApplicationIdParameter> [-Confirm] [-DomainController <Fqdn>]
