...
### Set1
```
Get-StaleMailboxReport [-EndDate <DateTime>] [-ResultSize <Unlimited>] [-StartDate <DateTime>] [<CommonParameters>]
```
...
[Online Version](https://technet.microsoft.com/library/cb42b081-092c-4239-ad93-eb8beee4c68a.aspx)
