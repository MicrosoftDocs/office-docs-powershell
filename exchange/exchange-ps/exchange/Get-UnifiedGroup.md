...
You can use the DisplayName value to identify the O365 group, but the results aren’t guaranteed to be unique. If you must return a singular and unique result, use a unique identifier for the O365 group.
