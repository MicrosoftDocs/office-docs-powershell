...
online version: https://docs.microsoft.com/powershell/module/exchange/set-outlookanywhere
...
## DESCRIPTION
For more information about the different authentication protocols that you can see in this article, see [Understanding HTTP Authentication](https://docs.microsoft.com/dotnet/framework/wcf/feature-details/understanding-http-authentication).
