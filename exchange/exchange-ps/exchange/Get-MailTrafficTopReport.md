...
**Note**: This cmdlet is in the process of being deprecated. Use the Get-MailTrafficSummaryReport cmdlet instead.
...
```
Get-MailTrafficTopReport [-Action <MultiValuedProperty>]
 [-AggregateBy <String>]
