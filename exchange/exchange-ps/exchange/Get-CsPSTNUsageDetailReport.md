...
online version: https://docs.microsoft.com/powershell/module/exchange/get-cspstnusagedetailreport
applicable: Exchange Online
title: Get-CsPSTNUsageDetailReport
schema: 2.0.0
author: chrisda
ms.author: chrisda
ms.reviewer:
...
```
Get-CsPSTNUsageDetailReport [-EndDate <DateTime>] [-ResultSize <Unlimited>] [-StartDate <DateTime>] [<CommonParameters>]
```
