...
The Remove-PublicFolder cmdlet removes the public folder data from all servers in your organization. If you only want to remove data from one server, use the Set-PublicFolder cmdlet with the Replicas parameter.
...
[Online Version](https://technet.microsoft.com/library/dda460e0-2601-49ae-a43f-c75c69719196.aspx)
