...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-remotedomain
...
```
Remove-RemoteDomain [-Identity] <RemoteDomainIdParameter> [-Confirm] [-DomainController <Fqdn>] [-WhatIf]
 [<CommonParameters>]
```
