...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-outboundconnector
...
```
Remove-OutboundConnector [-Identity] <OutboundConnectorIdParameter> [-Confirm] [-WhatIf] [<CommonParameters>]
```
