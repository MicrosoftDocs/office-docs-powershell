...
The Identity parameter specifies the identityof the mail contact. You can use the following values:
...
The Identity parameter specifies the identity of the mail contact. You can use the following values:
