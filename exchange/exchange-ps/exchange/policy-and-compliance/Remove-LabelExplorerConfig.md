...
Use the Remove-LabelExplorerConfig cmdlet to remove sensitivity label explorer configurations from your organization.
...
### -Identity
The Identity parameter specifies the sensitivity label explorer configuration that you want to remove.
