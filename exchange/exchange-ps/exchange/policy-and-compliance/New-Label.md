...
### Set1
```
New-Label -Name <String> [-Comment <String>] [-Conditions <MultiValuedProperty>] [-Confirm] [-DisplayName <String>] [-LabelActions <MultiValuedProperty>] [-ParentId <ComplianceRuleIdParameter>] [-Settings <PswsHashtable>] [-WhatIf]
```
