...
Use the Remove-ProtectionAlert cmdlet to remove alert policies from the Security & Compliance Center.
...
```
Remove-ProtectionAlert [-Identity] <PolicyIdParameter> [-Confirm] [-ForceDeletion] [-WhatIf]
 [<CommonParameters>]
```
