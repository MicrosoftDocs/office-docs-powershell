...
Use the Get-AuditConfig cmdlet to view the auditing configuration in the Microsoft Purview portal.
...
This example shows the auditing configuration in the Microsoft Purview portal.
