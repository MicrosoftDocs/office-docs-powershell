...
Use the Remove-SettingOverride cmdlet to remove setting overrides that were created using the New-SettingOverride cmdlet.
...
```
Remove-SettingOverride -Identity "Change Processor Discretionary Values"
```

This example removes the setting override named Change Processor Discretionary Values.
