...
online version: https://docs.microsoft.com/powershell/module/exchange/add-ipblocklistprovider
...
```
Add-IPBlockListProvider [-Name] <String> -LookupDomain <SmtpDomain> [-AnyMatch <Boolean>]
