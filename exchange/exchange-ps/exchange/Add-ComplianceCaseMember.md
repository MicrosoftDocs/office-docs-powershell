...
Use the Add-ComplianceCaseMember cmdlet to add an individual member to an eDiscovery case in the Microsoft Purview portal. To replace all existing members, use the Update-ComplianceCaseMember cmdlet.
