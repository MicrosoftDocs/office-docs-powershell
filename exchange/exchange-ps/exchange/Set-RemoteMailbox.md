...
online version: https://docs.microsoft.com/powershell/module/exchange/set-remotemailbox
...
- A migrated shared mailbox cannot be converted to regular mailbox and a migrated regular mailbox cannot be converted to shared mailbox.
