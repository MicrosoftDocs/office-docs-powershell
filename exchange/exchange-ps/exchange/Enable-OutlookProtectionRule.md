...
online version: https://docs.microsoft.com/powershell/module/exchange/enable-outlookprotectionrule
...
```
Enable-OutlookProtectionRule [-Identity] <RuleIdParameter> [-Confirm] [-DomainController <Fqdn>] [-WhatIf]
 [<CommonParameters>]
```
