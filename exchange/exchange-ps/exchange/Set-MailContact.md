...
online version: https://learn.microsoft.com/powershell/module/exchange/set-mailcontact
...
If you don't include a Type value for an email address, the value smtp is assumed. The syntax of SMTP email addresses is validated, but the syntax of other email address types isn't validated. Therefore, you need to verify that any custom addresses are formatted correctly.
