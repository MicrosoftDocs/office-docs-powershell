...
Use the New-AutoSensitivityLabelPolicy cmdlet to create auto-labeling policies in your organization.  Create auto-labeling policy rules using New-AutoSensitivityLabelRule cmdlet and assoicate them with the policy to complete the policy creation.
