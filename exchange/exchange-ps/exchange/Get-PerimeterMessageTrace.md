...
online version: https://docs.microsoft.com/powershell/module/exchange/get-perimetermessagetrace
...
Use the Get-PerimeterMessageTrace cmdlet to.
...
```
Get-PerimeterMessageTrace -Recipient <String>
 [-End <DateTime>]
 [-Sender <String>]
 [-Start <DateTime>]
 [<CommonParameters>]
