...
online version: https://docs.microsoft.com/powershell/module/exchange/suspend-publicfoldermoverequest
...
```
Suspend-PublicFolderMoveRequest [-Identity] <PublicFolderMoveRequestIdParameter> [-Confirm]
