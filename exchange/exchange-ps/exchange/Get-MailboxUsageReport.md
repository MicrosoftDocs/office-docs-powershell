...
online version: https://docs.microsoft.com/powershell/module/exchange/get-mailboxusagereport
...
```
Get-MailboxUsageReport [-EndDate <DateTime>] [-ResultSize <Unlimited>] [-StartDate <DateTime>] [<CommonParameters>]
```
