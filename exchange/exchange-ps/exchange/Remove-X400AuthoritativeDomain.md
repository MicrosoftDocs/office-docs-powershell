...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-x400authoritativedomain
...
```
Remove-X400AuthoritativeDomain [-Identity] <X400AuthoritativeDomainIdParameter> [-Confirm]
