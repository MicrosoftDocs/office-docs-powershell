...
online version: https://docs.microsoft.com/powershell/module/exchange/enable-hostedoutboundspamfilterrule
...
```
Enable-HostedOutboundSpamFilterRule [-Identity] <RuleIdParameter> [-Confirm] [-WhatIf] [<CommonParameters>]
```
