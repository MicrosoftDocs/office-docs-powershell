...
online version: https://docs.microsoft.com/powershell/module/exchange/set-caseholdrule
...
Use the Set-CaseHoldRule cmdlet to modify existing case hold rules in the Microsoft 365 compliance center.
