...
Use the Get-CaseHoldPolicy to view existing case hold policies in the Microsoft Purview portal. To get relevant information about how the hold was applied and the affected locations, you need to include the DistributionDetail switch.
