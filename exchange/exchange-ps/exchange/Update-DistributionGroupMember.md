...
The Identity parameterspecifies the identity of the distribution group.
...
The Members parameter specifies the recipient or Active Directory user to update as a member of the distribution group.
...
Separate multiple users with a comma, for example, "contoso\\ayla","contoso\\tony".
...
To specify a recipient, you can use any of the following values:
...
To specify an Active Directory user, you can choose from this subset of the values:
