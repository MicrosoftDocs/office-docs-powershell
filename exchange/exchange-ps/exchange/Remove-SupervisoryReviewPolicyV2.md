...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-supervisoryreviewpolicyv2
...
Use the Remove-SupervisoryReviewPolicyV2 cmdlet to remove supervisory review policies from the Security & Compliance Center.
...
```
Remove-SupervisoryReviewPolicyV2 [-Identity] <PolicyIdParameter> [-Confirm] [-ForceDeletion] [-WhatIf]
 [<CommonParameters>]
```
