...
Use the Remove-PublicFolderMailboxMigrationRequest cmdlet to remove an individual mailbox job in a public folder migration batch created using New-MigrationBatch cmdlet."
...
```
Remove-PublicFolderMailboxMigrationRequest -Identitiy \PublicFolderMailboxMigrationac6d9eb4-ee49-405f-b90d-04e9a258bd7e
```

This example uses the Identity parameter to specify the request to remove.
...
The Identity parameter specifes the public folder mailbox migration request that you want to remove. The default identity value is \\PublicFolderMailboxMigration\<UniqueIdentifier\> (for example, \\PublicFolderMailboxMigrationac6d9eb4-ee49-405f-b90d-04e9a258bd7e).

- Identity (for example, \\PublicFolderMailboxMigrationac6d9eb4-ee49-405f-b90d-04e9a258bd7e)

- RequestGUID value (for example afb77aca-d0a7-4c31-904c-785203a28d3a)
