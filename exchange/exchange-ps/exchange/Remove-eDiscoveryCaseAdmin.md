...
Use the Remove-eDiscoveryCaseAdmin cmdlet to remove an eDiscovery Administrator from the Microsoft Purview portal. To replace all eDiscovery Administrators, use the Update-eDiscoveryCaseAdmin cmdlet.
