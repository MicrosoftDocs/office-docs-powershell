...
Use the Start-ComplianceSearch cmdlet to start stopped, completed or not started compliance searches in Exchange Server 2016 or later and in the Microsoft Purview portal.
...
### -WhatIf
The WhatIf parameter doesn't work in the Microsoft Purview portal.
