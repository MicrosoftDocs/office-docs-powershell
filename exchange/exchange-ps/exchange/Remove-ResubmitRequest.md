...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-resubmitrequest
...
```
Remove-ResubmitRequest [-Identity] <ResubmitRequestIdentityParameter> [-Confirm] [-Server <ServerIdParameter>]
