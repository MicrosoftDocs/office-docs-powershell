...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-foreignconnector
...
```
Remove-ForeignConnector [-Identity] <ForeignConnectorIdParameter> [-Confirm] [-DomainController <Fqdn>]
