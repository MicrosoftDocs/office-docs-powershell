...
Use the New-RetentionComplianceRule cmdlet to create new retention rules in the Microsoft Purview portal.
...
The RetentionDurationDisplayHint parameter specifies the units that are used to display the retention duration in the Microsoft Purview portal. Valid values are:
