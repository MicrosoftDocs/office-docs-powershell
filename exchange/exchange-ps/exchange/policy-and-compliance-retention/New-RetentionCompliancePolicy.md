...
## DESCRIPTION
New policies are not valid and will not be applied until a retention rule is added to the policy. In addtiona, at least one location parameter must be defined to create a retention policy.
