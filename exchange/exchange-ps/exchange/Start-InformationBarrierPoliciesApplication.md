...
### -CleanupGroupSegmentLink
The CleanupGroupSegmentLink is a Switch parameter that indicates if group segment links need to be removed. You don't need to specify a value with this switch.
