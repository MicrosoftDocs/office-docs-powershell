...
```
Write-AdminAuditLog -Comment <String> [-Confirm]
...
[Online Version](https://docs.microsoft.com/powershell/module/exchange/policy-and-compliance-audit/write-adminauditlog)
