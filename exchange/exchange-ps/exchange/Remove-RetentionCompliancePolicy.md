...
Use the Remove-HoldCompliancePolicy cmdlet to remove retention policies from the Microsoft Purview portal. This cmdlet also removes the corresponding retention rule.
