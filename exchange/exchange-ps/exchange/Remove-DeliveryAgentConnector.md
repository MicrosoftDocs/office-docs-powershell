...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-deliveryagentconnector
...
```
Remove-DeliveryAgentConnector [-Identity] <DeliveryAgentConnectorIdParameter> [-Confirm]
