...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-compliancetag
...
Use the Remove-ComplianceTag cmdlet to remove retention labels from the Microsoft Purview portal. Retention labels apply retention settings to content.
