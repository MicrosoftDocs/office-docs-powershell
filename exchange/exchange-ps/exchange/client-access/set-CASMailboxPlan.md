...
```
Set-CASMailboxPlan [-Identity] <MailboxPlanIdParameter> [-ActiveSyncEnabled <$true | $false>] [-Confirm]
 [-ImapEnabled <$true | $false>] [-OwaMailboxPolicy <MailboxPolicyIdParameter>] [-PopEnabled <$true | $false>]
