...
- $false: The Report junk, Report phishing, Report not junk and Unsubscribe options aren't available. The users still be able to mark messages as junk, phishing, and not junk, but they won't be able to report messages to Microsoft.
