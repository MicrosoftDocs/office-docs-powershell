...
Use the New-ActivityAlert cmdlet to create activity alerts in the Microsoft 365 Defender portal or the Microsoft Purview portal. Activity alerts send you email notifications when users perform specific activities in Microsoft 365.
