...
```
> [!NOTE]
> For Office 365 or Exchange online tenants, use "Azure AD Authentication" as the input value
...
```
> [!NOTE]
> If the tenant is hosted in Office 365 U.S. Government GCC High or DoD environment, MetadataUrl should be https://login.microsoftonline.us/FederationMetadata/2006-12/FederationMetadata.xml
