...
### -MaxParallelSize
The MaxParallelSize parameter controls the maximum number of restoring threads in parallel. For multiple mailbox restore scenarios, running more threads in parallel will typically improve the completion time of Restore-RecoverableItems. Parallel threads will not improve single mailbox restore scenarios.

Valid values: integers from 1 to 10.
