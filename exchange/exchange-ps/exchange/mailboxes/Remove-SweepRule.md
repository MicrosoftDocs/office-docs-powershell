...
### -Mailbox
The Mailbox parameter specifies the mailbox that contains the rule you want to remove. You can use any value that uniquely identifies the mailbox.
...
[Online Version](https://technet.microsoft.com/library/c0b08f89-a570-40d0-a409-5d3e49c1dd99.aspx)
