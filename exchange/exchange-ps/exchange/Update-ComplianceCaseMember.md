...
Use the Update-ComplianceCaseMember cmdlet to replace all members of eDiscovery cases in the Microsoft 365 compliance center. To add or remove existing members, use the Add-ComplianceCaseMember and Remove-ComplianceCaseMember cmdlets.
