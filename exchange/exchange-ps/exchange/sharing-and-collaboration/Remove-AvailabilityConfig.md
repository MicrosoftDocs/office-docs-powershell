...
```
Remove-AvailabilityConfig [[-Identity] <AvailabilityConfigIdParameter>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
...
[Online Version](https://technet.microsoft.com/library/77b521f2-384b-42e0-8839-78ed921a0810.aspx)
