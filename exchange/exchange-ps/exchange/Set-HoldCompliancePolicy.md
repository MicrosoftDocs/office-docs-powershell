...
Use the Set-HoldCompliancePolicy cmdlet to modify existing preservation policies in the Microsoft 365 compliance center.
...
**Note**: Please avoid using a piped Foreach-Object when adding or removing scope Locations : "Value1","Value2",..."ValueN" | Foreach-Object { Set-HoldCompliancePolicy -Identity "Regulation 123 Compliance" -RemoveExchangeLocation $_  }
