...
online version: https://docs.microsoft.com/powershell/module/exchange/get-groupactivityreport
applicable: Exchange Online
title: Get-GroupActivityReport
schema: 2.0.0
author: chrisda
ms.author: chrisda
ms.reviewer:
...
```
Get-GroupActivityReport [-EndDate <DateTime>] [-ReportType <ReportType>] [-ResultSize <Unlimited>] [-StartDate <DateTime>] [<CommonParameters>]
```
...
### Example 1
```powershell
Get-GroupActivityReport -ReportType Monthly -StartDate 05/01/2015 -EndDate 05/31/2015
```

This example shows the number of distribution groups created and deleted for the month of May, 2015
