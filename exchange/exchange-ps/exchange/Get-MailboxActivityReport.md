...
online version: https://docs.microsoft.com/powershell/module/exchange/get-mailboxactivityreport
applicable: Exchange Online
title: Get-MailboxActivityReport
schema: 2.0.0
author: chrisda
ms.author: chrisda
ms.reviewer:
...
```
Get-MailboxActivityReport [-EndDate <DateTime>] [-ReportType <ReportType>] [-ResultSize <Unlimited>] [-StartDate <DateTime>] [<CommonParameters>]
```
...
### Example 1
```powershell
Get-MailboxActivityReport -ReportType Monthly -StartDate 05/01/2015 -EndDate 05/31/2015
```

This example shows the number of mailboxes created and deleted for the month of May, 2015
