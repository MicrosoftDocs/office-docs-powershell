...
### Set1
```
Set-ApplicationAccessPolicy [-Identity] <ApplicationAccessPolicyIdParameter> [-Description <String>] [-Confirm] [-WhatIf]
```
...
### -------------------------- Example 1 --------------------------
```
Set-ApplicationAcessPolicy -Identity "596ade3a-1abe-4c5b-b7d5-a169c4b05d4a\7a774f0c-7a6f-11e0-85ad-07fb4824019b:S-1-5-21-724521725-2336880675-2689004279-1821338;8b6ce428-cca2-459a-ac50-d38bcc932258" -Description "Executive Assistant Policy"
```
