...
The RemoteMailboxServerLegacyDN parameter specifies the server legacy DN of the back-end server. To find the LegacyExchangeServerDN value, run the following command: `Get-ExchangeServer <ServerIdentity> | Format-List LegacyExchangeServerDN`.
