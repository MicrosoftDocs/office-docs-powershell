...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-sharingpolicy
...
```
Remove-SharingPolicy [-Identity] <SharingPolicyIdParameter> [-Confirm] [-DomainController <Fqdn>] [-WhatIf]
 [<CommonParameters>]
```
