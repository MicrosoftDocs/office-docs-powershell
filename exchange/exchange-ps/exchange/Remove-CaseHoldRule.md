...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-caseholdrule
...
Use the Remove-CaseHoldRule cmdlet to remove case hold rules from the Microsoft 365 compliance center.
