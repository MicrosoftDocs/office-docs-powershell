...
Use the New-DlpEdmSchema cmdlet to create exact data match (EDM)-based classification schemas in the Microsoft Purview portal. Such schemas can be used with data loss prevention (DLP) policies.
