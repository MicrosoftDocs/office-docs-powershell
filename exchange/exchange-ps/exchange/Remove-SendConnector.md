...
online version: https://docs.microsoft.com/powershell/module/exchange/remove-sendconnector
...
```
Remove-SendConnector [-Identity] <SendConnectorIdParameter> [-Confirm] [-DomainController <Fqdn>] [-WhatIf]
 [<CommonParameters>]
```
