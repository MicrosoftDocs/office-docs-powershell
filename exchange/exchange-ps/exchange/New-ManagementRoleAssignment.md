...
The RecipientGroupScope parameter specifies a universal security group to consider for scoping a role assignment. Direct members of this group are considered in scope for the assignment. Only direct membership is considered in scope. Nested groups are not supported. You can use any value that uniquely identifies the group: Name, DistinguishedName, GUID, or DisplayName.
