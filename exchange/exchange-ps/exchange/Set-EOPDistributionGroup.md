...
online version: https://learn.microsoft.com/powershell/module/exchange/set-eopdistributiongroup
...
### -Alias
The Alias parameter specifies the alias of the distribution group. The maximum length is 64 characters.
