...
- As of February 24 2025, the AllowLegacyExchangeTokens switch lists any add-in that requested an Exchange token and whether the request was allowed or blocked.
