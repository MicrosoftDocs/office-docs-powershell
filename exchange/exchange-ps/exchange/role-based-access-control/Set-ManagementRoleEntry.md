...
### -Identity
The Identity parameter specifies the role entry to change. A valid value for this parameter uses the syntax ManagementRole\RoleEntryName (for example, ExampleRole\Set-Mailbox).
