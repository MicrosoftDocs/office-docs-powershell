...
ms.assetid: ccfd43d1-991c-4936-adb3-fbda792ca707
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Configuration.Tasks.ActiveSyncDeviceClassIdParameter  <br/> |The _Identity_ parameter specifies the group of devices on which to scope the task. <br/> |
