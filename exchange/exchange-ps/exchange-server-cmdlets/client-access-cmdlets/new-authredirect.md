...
ms.assetid: 66fc6568-469f-4f06-9864-841cdbf7d367
...
|:-----|:-----|:-----|:-----|
| _AuthScheme_ <br/> |Required  <br/> |Microsoft.Exchange.Data.Directory.SystemConfiguration.AuthScheme  <br/> |The _AuthScheme_ parameter specifies the authentication scheme that's used by the authentication redirection object. Typically, this value is `Bearer`.  <br/> |
| _TargetUrl_ <br/> |Required  <br/> |System.String  <br/> |The _TargetUrl_ parameter specifies the FQDN of the Exchange 2013 or later server that has the Client Access server role installed that's responsible for processing the redirected OAuth authentication requests. <br/> |
