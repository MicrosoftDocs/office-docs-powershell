...
ms.assetid: 63c48908-1116-4bab-8e5a-6c4dccbf3574
...
```
Get-OwaVirtualDirectory [-Identity <VirtualDirectoryIdParameter>] <COMMON PARAMETERS>
...
The **Get-OwaVirtualDirectory** cmdlet can be run on a local server or run remotely if the server name is specified in the _Identity_ or _Server_ parameters.
