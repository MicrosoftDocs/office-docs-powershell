...
ms.assetid: 3e80fb04-531f-4044-b957-9ba4fc712e4b
...
```
New-OutlookProvider -Name <String> [-Confirm [<SwitchParameter>]] [-DomainController <Fqdn>] [-WhatIf [<SwitchParameter>]]
...
|:-----|:-----|:-----|:-----|
| _Name_ <br/> |Required  <br/> |System.String  <br/> |The _Name_ parameter provides the common name of the **AutoDiscoverConfig** object. This can be a user-friendly name for identification. <br/> |
