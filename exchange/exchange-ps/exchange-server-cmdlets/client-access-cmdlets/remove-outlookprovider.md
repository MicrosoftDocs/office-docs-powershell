...
ms.assetid: b01d44c2-d9f9-4d58-9ce3-2db3e998ed25
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Configuration.Tasks.OutlookProviderIdParameter  <br/> |The _Identity_ parameter specifies the **AutoDiscoverConfig** object to remove from Active Directory. <br/> |
