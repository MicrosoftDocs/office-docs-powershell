...
ms.assetid: 92d6c890-a96a-469a-b864-99d9656b12e0
...
```
Disable-MailPublicFolder -Identity <MailPublicFolderIdParameter> [-Confirm [<SwitchParameter>]] [-DomainController <Fqdn>] [-WhatIf [<SwitchParameter>]]
