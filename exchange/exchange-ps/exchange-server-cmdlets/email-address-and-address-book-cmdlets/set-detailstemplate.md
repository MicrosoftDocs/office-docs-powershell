...
ms.assetid: 2e2ec63c-fd46-48c5-b21f-f1dc113f1b05
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Configuration.Tasks.DetailsTemplateIdParameter  <br/> | The _Identity_ parameter specifies the details template using a GUID or specifies a template type and language separated by a slash. The following is an example of the user template type and U.S. English language: en-us\User. Details template types include: <br/>  User <br/>  Group <br/>  PublicFolder <br/>  SearchDialog <br/>  MailboxAgent <br/>  Contact <br/> |
...
| _Pages_ <br/> |Optional  <br/> |Microsoft.Exchange.Data.MultiValuedProperty  <br/> |This parameter is reserved for internal Microsoft use.  <br/> |
