...
ms.assetid: 55efbcfc-838c-404c-a5b2-bbd7270ff0c5
...
| _Identity_ <br/> |Optional  <br/> |Microsoft.Exchange.Configuration.Tasks.DetailsTemplateIdParameter  <br/> | The _Identity_ parameter specifies the GUID of the details template or specifies the details template type and language separated by a backslash, for example, en-us\User. Details template types are: <br/>  User <br/>  Group <br/>  PublicFolder <br/>  SearchDialog <br/>  MailboxAgent <br/>  Contact <br/> |
