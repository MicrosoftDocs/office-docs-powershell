...
ms.assetid: 54ddf362-af4f-402f-8d70-aaf81d074b16
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Configuration.Tasks.OfflineAddressBookIdParameter  <br/> |The _Identity_ parameter specifies the GUID, distinguished name (DN), or OAB name that represents a specific OAB. You can also include the path by using the format _Server\OfflineAddressBookName_.  <br/> You can omit the parameter label so that only the OAB name or GUID is supplied.  <br/> |
