...
ms.assetid: d0058d0e-7f9c-4dba-b358-fb9adf21c1e3
...
```
Set-ClassificationRuleCollection -FileData <Byte[]> [-Confirm [<SwitchParameter>]] [-DomainController <Fqdn>] [-WhatIf [<SwitchParameter>]]
