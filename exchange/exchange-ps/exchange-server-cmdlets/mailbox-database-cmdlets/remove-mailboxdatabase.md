...
ms.assetid: 4d07d736-1dd7-43af-9f54-37d7c648572e
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Configuration.Tasks.DatabaseIdParameter  <br/> | The _Identity_ parameter specifies the mailbox database to remove. You can use one of the following values: <br/>  GUID <br/>  Distinguished name (DN) <br/>  Name of the mailbox database <br/> |
