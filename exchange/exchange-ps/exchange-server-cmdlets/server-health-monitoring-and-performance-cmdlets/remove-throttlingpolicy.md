...
ms.assetid: d98b709b-672e-42ad-afc4-c6e860d33bc9
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Configuration.Tasks.ThrottlingPolicyIdParameter  <br/> |The _Identity_ parameter identifies the throttling policy you want to remove. Use the name that matches the name of the policy in Active Directory. <br/> |
