...
ms.assetid: 57bed861-31c9-428d-bbd7-165ce7743ae6
...
```
Get-SafeLinksRule [-Identity <RuleIdParameter>] [-State <Enabled | Disabled>]
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Optional  <br/> |Microsoft.Exchange.MessagingPolicies.Rules.Tasks.RuleIdParameter  <br/> | The _Identity_ parameter specifies the Safe Links rule that you want to view. <br/>  You can use any value that uniquely identifies the rule. For example: <br/>  Name <br/>  Distinguised name (DN) <br/>  GUID <br/> |
