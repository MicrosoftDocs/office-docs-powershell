...
ms.assetid: 0d3b131c-e80f-426b-9140-7e674ab2b1ad
...
```
Remove-SafeAttachmentPolicy -Identity <SafeAttachmentPolicyIdParameter> [-Confirm [<SwitchParameter>]] [-Force <SwitchParameter>] [-WhatIf [<SwitchParameter>]]
