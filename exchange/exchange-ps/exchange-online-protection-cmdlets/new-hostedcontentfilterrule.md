...
ms.assetid: 2df13ba9-1eb0-4da3-bd72-a79d5fa15e26
...
| _Enabled_ <br/> |Optional  <br/> |System.Boolean  <br/> |The  _Enabled_ parameter enables or disables the rule. Valid input for this parameter is `$true` or `$false`. The default value is  `$true`.  <br/> |
