...
ms.assetid: eb658430-ac2e-4c5b-89a3-acfb3bed1b69
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.MessagingPolicies.Rules.Tasks.RuleIdParameter  <br/> | The _Identity_ parameter specifies the Safe Links rule that you want to modify. <br/>  You can use any value that uniquely identifies the rule. For example: <br/>  Name <br/>  Distinguised name (DN) <br/>  GUID <br/> |
...
| _Name_ <br/> |Optional  <br/> |System.String  <br/> |The Name parameter specifies a unique name for the Safe Links rule. If the value contains spaces, enclose the value in quotation marks (").  <br/> |
