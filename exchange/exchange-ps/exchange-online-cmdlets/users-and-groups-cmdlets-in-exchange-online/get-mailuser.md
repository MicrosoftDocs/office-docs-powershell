...
ms.assetid: 37b36f1c-95ec-4896-a08a-985ef4aa23b7
...
| _ArchiveDatabase_ <br/> |Optional  <br/> |Microsoft.Exchange.Configuration.Tasks.DatabaseIdParameter  <br/> |This parameter is reserved for internal Microsoft use.  <br/> |
...
| _Identity_ <br/> |Optional  <br/> |Microsoft.Exchange.Configuration.Tasks.MailUserIdParameter  <br/> | The _Identity_ parameter specifies the mail user that you want to view. You can use any value that uniquely identifies the mail user. <br/>  For example: <br/>  Name <br/>  Display name <br/>  Alias <br/>  Distinguished name (DN) <br/>  Canonical DN <br/>  Email address <br/>  GUID <br/> |
...
| _SoftDeletedMailUser_ <br/> |Optional  <br/> |System.Management.Automation.SwitchParameter  <br/> |This parameter is available only in the cloud-based service.  <br/> The  _SoftDeletedMailUser_ switch specifies whether to include only soft-deleted mail users in the results. You don't need to specify a value with this switch. <br/>  This switch is required to return soft-deleted mail users. <br/> Soft-deleted mail users are deleted mail users that are still recoverable.  <br/> |
