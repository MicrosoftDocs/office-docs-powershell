...
ms.assetid: db6a2233-c413-42a0-a264-f65a2733ad09
...
```
Remove-MigrationUser -Identity <MigrationUserIdParameter> [-Confirm [<SwitchParameter>]] [-DomainController <Fqdn>] [-Force <SwitchParameter>] [-Partition <MailboxIdParameter>] [-WhatIf [<SwitchParameter>]]
...
|:-----|:-----|:-----|:-----|
| _Identity_ <br/> |Required  <br/> |Microsoft.Exchange.Management.Migration.MigrationService.User.MigrationUserIdParameter  <br/> |The  _Identity_ parameter specifies the user that you want to remove from the migration batch. <br/> |
