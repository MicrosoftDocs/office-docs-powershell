...
>
> While any customer may use the following configuration parameters, the functionality will only work for customers that are participating in the respective private preview for these features. General Availability for this functionality has not been determined at this time.
>
