...
```
New-CsTeamsMeetingBackgroundImage -Id <String> -Order <Int64> -Name <String> [-IsRequired <Boolean>]
 [-IsHidden <Boolean>] -ImageUri <String> [<CommonParameters>]
```
...
### MeetingBackgroundImage.Cmdlets.MeetingBackgroundImage
