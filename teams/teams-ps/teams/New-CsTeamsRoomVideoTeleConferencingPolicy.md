...
online version: https://learn.microsoft.com/powershell/module/skype/new-csteamsnetworkroamingpolicy
schema: 2.0.0
---
...
New-CsTeamsRoomVideoTeleConferencingPolicy [-Identity] <String> [-AreaCode <String>] [-Description <String>]
 ...
 [-ReceiveExternalCalls <String>] [-ReceiveInternalCalls <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
