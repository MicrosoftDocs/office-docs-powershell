...
```
Set-CsTeamsUpdateManagementPolicy [-UpdateDayOfWeek <Object>] [-Description <Object>] [-UpdateTime <Object>]
 [-WhatIf] [-UpdateTimeOfDay <Object>] [-Confirm] [-AllowManagedUpdates <Object>] [[-Identity] <Object>]
 [-AllowPreview <Object>] [-Tenant <Object>] [-Force] [-Instance <Object>] [-AsJob]
```
