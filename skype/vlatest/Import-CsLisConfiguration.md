...
Calling Import-CsLisConfiguration will restore the configuration from that file.
...
You call Export-CsLisConfiguration to back up your configuration.
Later, you modify the Location property of that wireless access point to Building30/Rooms20-40.
If you then call Import-CsLisConfiguration to restore the backed-up configuration, the location for that WAP will be Building30/Room10 (the location before the backup), but the location for Building30/Rooms20-40 will remain in the location configuration database.

Who can run this cmdlet: By default, members of the following groups are authorized to run the Import-CsLisConfiguration cmdlet locally: RTCUniversalServerAdmins.
...
The contents of the file that we read with Get-Content is piped to the Import-CsLisConfiguration cmdlet, which imports the saved configuration into the location configuration database.
...
[Online Version](http://technet.microsoft.com/EN-US/library/579c0c38-311b-4961-b924-11731403d9f2(OCS.14).aspx)
...
[Online Version](http://technet.microsoft.com/EN-US/library/579c0c38-311b-4961-b924-11731403d9f2(OCS.15).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/579c0c38-311b-4961-b924-11731403d9f2(OCS.16).aspx)
