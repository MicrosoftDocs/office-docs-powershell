...
This also applies to Lync Server Control Panel.
For example, an Archiving Administrator cannot disable a user by using Lync Server Control Panel because Lync Server Control Panel abides by RBAC roles.
...
After the custom role has been created, you can then use Set-CsAdminRole to modify the properties of that new role.

Who can run this cmdlet: By default, members of the following groups are authorized to run the Set-CsAdminRole cmdlet locally: RTCUniversalServerAdmins.
...
The preceding command adds a new OU (Portland) to the UserScopes property for the RBAC role RedmondVoiceAdministrators.
...
If you want to add Export-CsArchivingData to the cmdlets already stored in that property, use this syntax instead:
...
###  
Set-CsAdminRole does not return a value or object.
...
[Online Version](http://technet.microsoft.com/EN-US/library/ec927ce6-a37b-4876-a6df-a347404f4e84(OCS.14).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/ec927ce6-a37b-4876-a6df-a347404f4e84(OCS.15).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/ec927ce6-a37b-4876-a6df-a347404f4e84(OCS.16).aspx)
