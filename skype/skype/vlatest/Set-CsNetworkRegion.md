...
Who can run this cmdlet: By default, members of the following groups are authorized to run the Set-CsNetworkRegion cmdlet locally: RTCUniversalServerAdmins.
...
To do this we call Set-CsNetworkRegion, passing an Identity of EMEA.
...
In this case the action is to call Set-CsNetworkRegion with an Identity of Asia to set the properties of the Asia region.
...
[Online Version](http://technet.microsoft.com/EN-US/library/ffa1774b-ac60-4392-ad55-07bb887bf945(OCS.14).aspx)
...
[Online Version](http://technet.microsoft.com/EN-US/library/ffa1774b-ac60-4392-ad55-07bb887bf945(OCS.15).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/ffa1774b-ac60-4392-ad55-07bb887bf945(OCS.16).aspx)
