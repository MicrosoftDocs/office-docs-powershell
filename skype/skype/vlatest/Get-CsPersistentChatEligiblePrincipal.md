...
You can retrieve the list of allowed members for a room or category by using the Get-CsPersistentChatRoom and the Get-CsPersistentChatCategory cmdlets.
However, if a security group, OU, or domain has been added to the allowed members list you will not see the names of the users in that security group, OU, or domain.
...
To do this, Get-CsPersistentChatEligiblePrincipal is first used to return all the presenters for the chat room HelpDeskChatRoom.
...
###  
None.
Get-CsPersistentChatEligiblePrincipal does not accept pipelined data.

###  
None.
The Get-CsPersistentChatEligiblePrincipal cmdlet does not accept pipelined data.

## OUTPUTS

###  
Get-CsPersistentChatEligiblePrincipal returns instances of the Microsoft.Rtc.Management.GroupChat.Cmdlets.ADPersistentChatPrincipal object.
...
[Online Version](http://technet.microsoft.com/EN-US/library/541de778-3aca-4d3f-9d46-d9b6d8212987(OCS.15).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/541de778-3aca-4d3f-9d46-d9b6d8212987(OCS.16).aspx)
