...
Who can run this cmdlet: By default, members of the following groups are authorized to run the New-CsTrunkConfiguration cmdlet locally: RTCUniversalServerAdmins.
