...
## DESCRIPTION
The unified contact store (introduced in Lync Server 2013 enables users to access their contact list from multiple applications, including Skype for Business, Outlook 2013, and Outlook Web App.
...
###  
None.
The Debug-CsUnifiedContactStore cmdlet does not accept pipelined data.
...
[Online Version](http://technet.microsoft.com/EN-US/library/8e92d262-604d-41b1-9530-947765025a79(OCS.16).aspx)
