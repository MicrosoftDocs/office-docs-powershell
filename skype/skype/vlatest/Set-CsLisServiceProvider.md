...
Who can run this cmdlet: By default, members of the following groups are authorized to run the Set-CsLisServiceProvider cmdlet locally: RTCUniversalServerAdmins.
...
Because of that, the first line in this example is a call to the Windows PowerShell cmdlet Read-Host.
Read-Host will prompt for user input.
...
[Online Version](http://technet.microsoft.com/EN-US/library/3fe2878c-6ad2-4b7f-a844-e978c263163f(OCS.14).aspx)

[Remove-CsLisServiceProvider]()

[Get-CsLisServiceProvider]()

[Online Version](http://technet.microsoft.com/EN-US/library/3fe2878c-6ad2-4b7f-a844-e978c263163f(OCS.15).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/3fe2878c-6ad2-4b7f-a844-e978c263163f(OCS.16).aspx)
