...
Because the Level parameter was not specified, Export-CsPersistentChatData will do a full export of the Persistent Chat information.
...
###  
None.
Export-CsPersistentChatData does not accept pipelined input.

###  
None.
The Export-CsPersistentChatData cmdlet does not accept pipelined input.

## OUTPUTS

###  
Export-CsPersistentChatData creates .ZIP files.
...
[Online Version](http://technet.microsoft.com/EN-US/library/f4855109-26e0-41b8-8a9f-890f8d892645(OCS.15).aspx)

[Online Version](http://technet.microsoft.com/EN-US/library/f4855109-26e0-41b8-8a9f-890f8d892645(OCS.16).aspx)
