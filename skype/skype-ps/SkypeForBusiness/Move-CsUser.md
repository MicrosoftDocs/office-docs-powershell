...
> [!NOTE]
>
> A fix for this regression is being worked on and will be included in the next Skype for Business on-premises Cumulative Update (CU). After applying the upcoming CU, customers should upgrade to the latest MicrosoftTeams module version.
