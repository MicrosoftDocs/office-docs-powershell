...
```
New-CsTenantNetworkSubnet [-Description <Object>] [-WhatIf] [-SubnetID <Object>] [-Confirm]
 [[-Identity] <Object>] [-Tenant <Object>] [-InMemory] [-MaskBits <Object>] [-NetworkSiteID <Object>] [-Force]
 [-AsJob]
```
