...
## DESCRIPTION
**Note**: Starting with Teams PowerShell Module 4.0 (available on 1st March'22), this cmdlet is deprecated. Use the Get-CsTenant cmdlet to view information previously present in Get-CsOnlineDirectoryTenant.
