...
```
New-CsTenantNetworkSite [-Description <Object>] [-WhatIf] [-OnlineVoiceRoutingPolicy <Object>]
 [-EnableLocationBasedRouting <Object>] [-Confirm] [-NetworkRegionID <Object>] [-SiteAddress <Object>]
 [[-Identity] <Object>] [-Tenant <Object>] [-InMemory] [-NetworkSiteID <Object>] [-Force]
 [-LocationPolicy <Object>] [-AsJob]
```
