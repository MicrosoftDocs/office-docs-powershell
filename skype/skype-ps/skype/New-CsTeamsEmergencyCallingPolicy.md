...
### Example 1
```powershell
PS C:>   New-CsTeamsEmergencyCallingPolicy -Identity ContosoECP -Description "Contoso ECP" -NotificationGroup "alert@contoso.com" -NotificationDialOutNumber "4253214567" -NotificationMode NotificationOnly -ExternalLocationLookupMode $Enable
```

 This example creates a Teams Emergency Calling policy that has a identity of ContosoECP, where a notification group and number is being defined and also the type of notification.
