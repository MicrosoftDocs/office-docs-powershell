...
## SYNOPSIS
Assigns an online voice mail policy to a user account, to a group of users or set the tenant Global instance. Online voicemail policies manage usages for Voicemail service.
