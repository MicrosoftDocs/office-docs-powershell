...
### -AllowShareFile
Designates whether users are able to leverage Citrix's ShareFile as a third party storage solution in Microsoft Teams.  If $true, users will be able to add Citrix's ShareFile in the client and interact with the files stored there.
