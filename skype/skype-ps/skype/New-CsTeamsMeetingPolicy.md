...
```
New-CsTeamsMeetingPolicy [[-Identity] <Object>] [-AllowChannelMeetingScheduling <Object>]
 ...
 [-EnableOutlookAddIn <Object>] [-Force] [-InMemory] [-Tenant <Object>] [-WhatIf] [-AsJob] [<CommonParameters>]
```
