...
You can use the asterisk (&ast;) wildcard character when using the Display Name as the user Identity.
For example, the Identity "&ast; Smith" returns all the users who have a display name that ends with the string value " Smith".
