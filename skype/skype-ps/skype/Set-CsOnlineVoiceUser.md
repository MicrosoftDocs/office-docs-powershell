...
[Remove-CsPhoneNumberAssignment](/powershell/module/teams/remove-csphonenumberassignment)cmdlet instead. The new cmdlets are currently not supported for customers/tenants that
