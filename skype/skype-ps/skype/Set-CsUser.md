...
**Note**: It is not required to set this parameter for Microsoft Teams users. Using this parameter for Microsoft Teams users in commercial and GCC cloud instances has been deprecated.
