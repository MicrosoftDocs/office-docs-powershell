...
For Direct Routing phone numbers in GCC High and DoD cloud instances it is not supported to assign a base phone number to a user or resource account, if you already have other users or resource accounts assigned with phone numbers with the same base phone number + extensions or vice versa. For instance if you have a user with the assigned phone number +14255551200;ext=123 you can't assign the phone number +14255551200 to another user or resource account.
