...
For example, this code returns a credential object for the user litwareinc\kenmyer and stores that object in a variable named named $x: $x = Get-Credential "litwareinc\kenmyer".
...
[Online Version](http://technet.microsoft.com/EN-US/library/bf755ca0-649a-43f3-80b3-8739a92fbad5(OCS.16).aspx)
