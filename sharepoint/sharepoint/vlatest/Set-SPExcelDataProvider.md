...
Set-SPExcelDataProvider [-Identity] <SPExcelDataProviderPipeBind>
 ...
 [-ProviderType <DataProviderType>] [-WhatIf]
```
...
```
C:\PS>Get-SPExcelServiceApplication -Identity "MyExcelService" | Get-SPExcelDataProvider | where {$_.providerID -eq "SQLOLEDB" } | Set-SPExcelDataProvider -Description "This is the Microsoft SQL OLEDB driver (MDAC)"
```
