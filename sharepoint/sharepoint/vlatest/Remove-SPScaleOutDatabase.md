...
Remove-SPScaleOutDatabase -Database <SPDatabasePipeBind> -ServiceApplication <SPServiceApplicationPipeBind>
 [-AssignmentCollection <SPAssignmentCollection>] [-Confirm] [-DeleteData] [-WhatIf]
```
...
C:\PS>Remove-SPScaleOutDatabase -ServiceApplication $serviceApplication -Database $database
```
