...
Set-SPExcelFileLocation [-Identity] <SPExcelFileLocationPipeBind>
 ...
 [-WorkbookSizeMax <Int32>] [-ChartRenderDurationMax <Int32>]
```
...
### -ExternalDataAllowed
Specifies the type of external data access allowed for workbooks: None specifies that data refresh is disabled.
