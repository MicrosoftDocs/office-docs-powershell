...
online version: http://technet.microsoft.com/EN-US/library/acc851e8-bf01-4b46-b0d6-f2deb7c6e0b7(Office.15).aspx
schema: 2.0.0
---
...
Remove-SPEnterpriseSearchServiceApplication [-Identity] <SearchServiceApplicationPipeBind>
 [-AssignmentCollection <SPAssignmentCollection>] [-Confirm] [-RemoveData] [-WhatIf]
```
